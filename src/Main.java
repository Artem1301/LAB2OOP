...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            String xmlPath = new File("src/plane.xml").getAbsolutePath();
            String xsdPath = new File("src/plane.xsd").getAbsolutePath();
            String xslPath = new File("src/transform.xsl").getAbsolutePath();
            String outputPath = new File("src/output.xml").getAbsolutePath();
